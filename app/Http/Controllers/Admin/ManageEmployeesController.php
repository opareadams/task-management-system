...
class ManageEmployeesController extends AdminBaseController
{
    ...
    public function store(StoreUser $request) {
        $validate = Validator::make(['job_title' => $request->job_title, 'hourly_rate' => $request->hourly_rate, 'joining_date' => $request->joining_date,'team_id' => $request->team_id, 'team2_id' => $request->team2_id], 
        [
            'job_title' => 'required',
            'hourly_rate' => 'numeric',
        ...
        if ($user->id) {
            ...
            $member2 = new EmployeeTeam2();
            $member2->user_id = $user->id;
            $member2->team2_id = $request->team2_id;
            $member2->save();
        }
