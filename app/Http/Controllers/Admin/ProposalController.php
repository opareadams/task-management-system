...
class ProposalController extends AdminBaseController
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        // Notify client
//        $notifyUser = User::findOrFail($proposal->client_id);
//        $notifyUser->notify(new NewProposal($proposal));
        ...
        return Reply::redirect(route('admin.proposals.show', $proposal->id), __('messages.proposalCreated'));
...
//        $notifyUser->notify(new NewProposal($proposal));
        ...
        return Reply::redirect(route('admin.proposals.show', $proposal->id), __('messages.proposalUpdated'));
