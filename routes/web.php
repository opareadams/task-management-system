...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(
        ...
        // Proposal routes
        Route::get('proposals/data', ['uses' => 'ProposalController@data'])->name('proposals.data');
        ...
        Route::group(
            ...
            Route::resource('teams2', 'ManageTeams2Controller');
            Route::resource('employee-teams2', 'ManageEmployeeTeams2Controller');
        });
        ...
        Route::group(
            ...
            Route::get('leave-report/export/{id?}', 'LeaveReportController@export')->name('leave-report.export');
    ...
    Route::group(
        ...
        // Proposal routes
        Route::get('proposals/data', ['uses' => 'MemberProposalController@data'])->name('proposals.data');
        ...
        Route::get('all-time-logs/data/{startDate?}/{endDate?}/{projectId?}', ['uses' => 'MemberAllTimeLogController@data'])->name('all-time-logs.data');
