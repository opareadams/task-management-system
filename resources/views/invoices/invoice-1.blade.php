    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        @foreach($taxes as $key=>$tax)
            <tr style="page-break-inside: avoid;" class="tax">
                ...
                <td class="unit">{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ $tax }}</td>
            </tr>
        @endforeach
        </tbody>
        <tfoot>
        <tr dontbreak="true">
            ...
            <td style="text-align: center">{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ $invoice->total }}</td>
        </tr>
        </tfoot>
    </table>
    <p>&nbsp;</p>
