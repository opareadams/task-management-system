                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="password" id="password" class="form-control" autocomplete="nope">
                                ...
                                <div class="row">
                                 ...
                                 <div class="col-md-3">
                                   ...
                                   <div class="col-md-3">
                                        <div class="form-group">
                                            <label hidden class="control-label"><i class="fa fa-slack"></i> @lang('modules.employees.slackUsername')</label>
                                            <div class="input-group"> <!--<span class="input-group-addon">@</span> -->
                                                <input autocomplete="nope" type="hidden" id="slack_username" name="slack_username" value="" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label hidden>@lang('modules.employees.joiningDate')</label>
                                            <input type="hidden" name="joining_date" id="joining_date" value="01/15/2019" class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-md-6">
                                        <div class="form-group">
                                            <label hidden>@lang('modules.employees.hourlyRate')</label>
                                            <input type="hidden" min="0" name="hourly_rate" id="hourly_rate" value="10" class="form-control">
                                        </div>
                                    </div>
                                    <!--/span-->
                                </div>
