    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
                <tr>
                    <td>Casual</td>
                    <td><span class="label-success label">{{ $casualLeaves }}</span></td>
                    <td>Sick</td>
                    <td><span class="label-danger label">{{ $sickLeaves }}</span></td>
                    <td>Earned</td>
                    <td><span class="label-info label">{{ $earnedLeaves }}</span></td>
                </tr>
            </table>
        </div>
    </div>
