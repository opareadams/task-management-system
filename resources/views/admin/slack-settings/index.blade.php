                        ...
                        <div id="vhome3" class="tab-pane active">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label for="company_name">Slack Webhook</label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Slack Notification Logo</label>
...
<script>
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            ...
            type: "POST",
            redirect: true,
            file: (document.getElementById("slack_logo").files.length == 0) ? false : true
        })
    });
</script>
<script>
